    ...
    return <>
        <div class="super-wrapper w-100 h-100 d-flex align-items-center justify-content-center">
            ...
            <div class="login-header text-left ">
                <h4 class="fw-light">Get started as a Seeker</h4>
                <p class="display-4 fw-medium">Create a Seeker Account</p>
            ...
            <div class="w-100">
                ...
                <div class="mb-3 d-flex justify-content-start">
                    <button type="submit" class="login-button"><a href="signup_page_seeker_fail.html" class="link">Register</a></button>
