...
urlpatterns=[
    ...
    path('specific_review/<int:comment_id>/', views.ReviewRetreive.as_view(), name='specific_comment'),
    path('specific_application/<int:comment_id>/', views.ApplicationCommentRetreive.as_view(), name='specific_application_comment'),
