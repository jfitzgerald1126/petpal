...
class Pet(models.Model):
    ...
    STATUS_OPTIONS = [('available', 'available'), ('withdrawn', 'withdrawn'), ('adopted', 'adopted')]
    ...
    status = models.CharField(max_length=10, null=False, blank=False, choices=STATUS_OPTIONS, default='listed')